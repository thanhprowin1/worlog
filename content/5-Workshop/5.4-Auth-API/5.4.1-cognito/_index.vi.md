...
![Tạo Cognito User Pool](/worlog/images/5-Workshop/5.4-Auth-API/cognito-create.png)

7. Review → **Create user pool**

<!-- TODO: screenshot - User pool overview sau khi tạo -->
![User pool đã tạo](/worlog/images/5-Workshop/5.4-Auth-API/cognito-created.png)
...
![Cấu hình Hosted UI](/worlog/images/5-Workshop/5.4-Auth-API/cognito-hosted-ui.png)
